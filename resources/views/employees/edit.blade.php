...
<div class="card" style="max-width: 800px;">
    <div class="card-body">
        <form action="{{ route('employees.update', $employee) }}" method="POST" class="grid grid-cols-2 gap-6">
            @csrf
            @method('PUT')
            
            <div>
                <label for="first_name" class="text-sm font-medium mb-4" style="display:block;">First Name</label>
                <input type="text" name="first_name" id="first_name" class="input" value="{{ old('first_name', $employee->first_name) }}" required>
                @error('first_name')
            ...
            <div>
                ...
                <input type="text" name="last_name" id="last_name" class="input" value="{{ old('last_name', $employee->last_name) }}" required>
                @error('last_name')
                    <span class="text-sm text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="email" name="email" id="email" class="input" value="{{ old('email', $employee->email) }}" required>
                @error('email')
                    <span class="text-sm text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="phone" id="phone" class="input" value="{{ old('phone', $employee->phone) }}" required>
                @error('phone')
                    <span class="text-sm text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.01" name="salary" id="salary" class="input" value="{{ old('salary', $employee->salary) }}" required>
                @error('salary')
                    <span class="text-sm text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="date" name="joining_date" id="joining_date" class="input" value="{{ old('joining_date', $employee->joining_date) }}" required>
                @error('joining_date')
                    <span class="text-sm text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-span-2">
                ...
                <textarea name="address" id="address" class="input" rows="3" required>{{ old('address', $employee->address) }}</textarea>
                @error('address')
                    <span class="text-sm text-danger">{{ $message }}</span>
                @enderror
            </div>
